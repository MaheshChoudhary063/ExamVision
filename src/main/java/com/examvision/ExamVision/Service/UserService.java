...
import com.examvision.ExamVision.DTO.ReqRes;
...
public class UserService {
    ...
    public ReqRes getUsersById(Long id) {
        ReqRes reqRes = new ReqRes();
        try {
            UserModel usersById = usersRepo.findById(id).orElseThrow(() -> new RuntimeException("User Not found"));
    ...
    public ReqRes updateUser(Long userId, UserModel updatedUser) {
        ReqRes reqRes = new ReqRes();
        try {
            Optional<UserModel> userOptional = usersRepo.findById(userId);
            if (userOptional.isPresent()) {
